...
$LNG['image_removed'] = 'A kép el lett távolítva';
$LNG['bio_description'] = 'The Bio description should be %s characters or less.';
$LNG['valid_email'] = 'Érvényes e-mail címet adj meg!';
$LNG['valid_url'] = 'Érvényes linket írj be!';
$LNG['valid_country'] = 'Valóságos országot adj meg!';
$LNG['password_too_short'] = 'A jelszó legalább 6 karakter hosszú legyen.';
$LNG['password_not_match'] = 'A jelszavak nem egyeznek.';
$LNG['wrong_current_password'] = 'A jelenlegi jelszót nem jól adtad meg!';
$LNG['username_not_found'] = 'Nincs ilyen felhasználónév.';
...
$LNG['email_sent'] = 'E-mail kiküldve!';
$LNG['email_reset'] = 'A jelszó-visszaállításhoz szükséges tudnivaló e-mailben ki lett küldve. Ha 24 órán belül nem kapod meg az e-mailt, akkor nézd meg a levélszemét (spam) mappában, vagy a kukában (törölt elemek)!';
$LNG['user_has_been_deleted'] = '<strong>%s</strong> felhasználó törölve.';
$LNG['theme_changed'] = 'A kinézet megváltozott';
$LNG['notif_saved'] = 'Az értesítések módosítva';
$LNG['notif_success_saved'] = 'Az értesítések frissítve lettek.';

// MAIL CONTENT
$LNG['welcome_mail'] = 'Üdvözöl %s';
$LNG['user_created'] = 'Köszönöm, hogy csatlakoztál <strong>%s</strong>.<br><br>Felhasználói neved: <strong>%s</strong><br><br>Belépés: <a href="%s" target="_blank">%s</a>';
